...
const file_store_workspace_setting_proto_rawDesc = "" +
	...
	"\x0euse_path_style\x18\x06 \x01(\bR\fusePathStyle\"\xe1\x04\n" +
	...
	"\x14content_length_limit\x18\x03 \x01(\x05R\x12contentLengthLimit\x12.\n" +
	"\x13enable_auto_compact\x18\x04 \x01(\bR\x11enableAutoCompact\x127\n" +
	...
	"\tnsfw_tags\x18\r \x03(\tR\bnsfwTags*s\n" +
